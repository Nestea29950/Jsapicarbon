...
app.get('/api', function (req, res) {
  ...
  async function calculCarbon() {
    try {
      ...
      console.log('performancescore:', data2.data.lighthouseResult.audits['diagnostics'].details);
      console.log(carbon);
      ...
      , {"id":3,"name":"first-contentful-paint-3g","score":data2.data.lighthouseResult.audits['first-contentful-paint-3g'].score,"description":data2.data.lighthouseResult.audits['first-contentful-paint-3g'].description,"categories":"front"}
      , {"id":4,"name":"interactive","score":data2.data.lighthouseResult.audits['interactive'].score,"description":data2.data.lighthouseResult.audits['interactive'].description,"categories":"front"}
      ...
      , {"id":6,"name":"main-thread-tasks","score":data2.data.lighthouseResult.audits['main-thread-tasks'].score,"description":data2.data.lighthouseResult.audits['main-thread-tasks'].description,"categories":"architecture"}
      ...
      , {"id":13,"name":"third-party-summary","score":data2.data.lighthouseResult.audits['third-party-summary'].score,"description":data2.data.lighthouseResult.audits['third-party-summary'].description,"categories":"back"}
      ...
      , {"id":18,"name":"largest-contentful-paint","score":data2.data.lighthouseResult.audits['largest-contentful-paint'].score,"description":data2.data.lighthouseResult.audits['largest-contentful-paint'].description,"categories":"front"}
      ...
      , {"id":22,"name":'unminified-javascript',"score": data2.data.lighthouseResult.audits['unminified-javascript'].score,"description":data2.data.lighthouseResult.audits['unminified-javascript'].description,"categories":"back"}
      ...
      , {"id":26,"name":'first-meaningful-paint',"score": data2.data.lighthouseResult.audits['first-meaningful-paint'].score,"description":data2.data.lighthouseResult.audits['first-meaningful-paint'].description,"categories":"front"}
      ...
      , {"id":29,"name":'uses-long-cache-ttl',"score": data2.data.lighthouseResult.audits['uses-long-cache-ttl'].score,"description":data2.data.lighthouseResult.audits['uses-long-cache-ttl'].description,"categories":"back"}
      ...
      , {"id":37,"name":'cumulative-layout-shift',"score": data2.data.lighthouseResult.audits['cumulative-layout-shift'].score,"description":data2.data.lighthouseResult.audits['cumulative-layout-shift'].description,"categories":"front"}
      , {"id":38,"name":'server-response-time',"score": data2.data.lighthouseResult.audits['server-response-time'].score,"description":data2.data.lighthouseResult.audits['server-response-time'].description,"categories":"back"}
      , {"id":39,"name":'mainthread-work-breakdown',"score": data2.data.lighthouseResult.audits['mainthread-work-breakdown'].score,"description":data2.data.lighthouseResult.audits['mainthread-work-breakdown'].description,"categories":"architecture"}
      ...
      , {"id":42,"name":'total-blocking-time',"score": data2.data.lighthouseResult.audits['total-blocking-time'].score,"description":data2.data.lighthouseResult.audits['total-blocking-time'].description,"categories":"front"}
      ...
      , {"id":44,"name":'total-byte-weight',"score": data2.data.lighthouseResult.audits['total-byte-weight'].score,"description":data2.data.lighthouseResult.audits['total-byte-weight'].description,"categories":"architecture"}
      ...
      , {"id":48,"name":'max-potential-fid',"score": data2.data.lighthouseResult.audits['max-potential-fid'].score,"description":data2.data.lighthouseResult.audits['max-potential-fid'].description,"categories":"front"}
      , {"id":49,"name":'speed-index',"score": data2.data.lighthouseResult.audits['speed-index'].score,"description":data2.data.lighthouseResult.audits['speed-index'].description,"categories":"front"}
      ...
      , {"id":54,"name":'dom-size',"score": data2.data.lighthouseResult.audits['dom-size'].score,"description":data2.data.lighthouseResult.audits['dom-size'].description,"categories":"architecture"}
      ...
      , {"id":56,"name":'render-blocking-resources',"score": data2.data.lighthouseResult.audits['render-blocking-resources'].score,"description":data2.data.lighthouseResult.audits['render-blocking-resources'].description,"categories":"architecture"}
      ...
      , {"id":60,"name":'first-contentful-paint',"score": data2.data.lighthouseResult.audits['first-contentful-paint'].score,"description":data2.data.lighthouseResult.audits['first-contentful-paint'].description,"categories":"front"}];
